  ...
  return (
    <div>
      <div className="slides">
        <button type="button" className="view" onClick={()=>setVisible(true)}><svg width="12" height="12" xmlns="http://www.w3.org/2000/svg"><g fill="#FFF" fill-rule="nonzero"><path d="M7.714 0l1.5 1.5-2.357 2.357 1.286 1.286L10.5 2.786l1.5 1.5V0zM3.857 6.857L1.5 9.214 0 7.714V12h4.286l-1.5-1.5 2.357-2.357zM8.143 6.857L6.857 8.143 9.214 10.5l-1.5 1.5H12V7.714l-1.5 1.5zM4.286 0H0v4.286l1.5-1.5 2.357 2.357 1.286-1.286L2.786 1.5z"/></g></svg>  VIEW IMAGE</button>
        {(visible)?
      ...
      <footer>
        ...
        <div className="bottom">
          ...
          <div className="buttons">
            <button disabled={(ctr===0)?true:false} type="button" onClick={()=>setCtr(ctr-1)} className={(ctr===0)?"btn1 inactive":"btn1"}>
            <IoPlaySkipBackOutline/>
            </button>
            <button disabled={(ctr===Record.length-1)?true:false} type="button" onClick={()=>setCtr(ctr+1)} className={(ctr===Record.length-1)?"btn2 inactive":"btn2"}>
